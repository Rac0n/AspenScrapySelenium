...
class AspenSpiderSpider1(scrapy.Spider):
    name = 'aspen_spider_regional'
    next_page = ""
    new_main_page = ""

    def start_requests(self):
        yield SeleniumRequest(
            url="https://www.aspentimes.com/recent-stories/regional/",
            wait_time=5,
            screenshot=False,
            callback=self.parse,
            dont_filter=True
    ...
    def parse(self, response):
        ...
        for url in get_urls:
            AspenSpiderSpider1.next_page = url
            next_url = url
    ...
    def parse_local(self, response):
        ...
        current_url = AspenSpiderSpider1.next_page
